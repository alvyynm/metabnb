  ...
  return (
    ...
    >
      <div
        ...
        className="bg-white mx-4 md:min-w-[80%] md:mx-[10%] lg:min-w-[37.5rem] border border-1 border-border1 rounded-xl absolute top-[6%] left-2 md:top-[10%] lg:top-[12%] lg:left-[20%]"
      >
